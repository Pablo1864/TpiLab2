...
router.post('/eliminarDeterminantes/:idDeterminante', examenesController.eliminarDeterminante);
router.get('/obtener-valores-referencia/:idDeterminante', examenesController.obtenerValoresReferenciaPorDeterminante);
router.post('/agregarValoresReferencia', examenesController.agregarValoresReferencia);
